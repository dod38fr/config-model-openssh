...
Select and install C<config-model-openssh> and C<config-model-tkui>
...
L<the user mailing list|https://lists.sourceforge.net/lists/listinfo/config-model-users>
